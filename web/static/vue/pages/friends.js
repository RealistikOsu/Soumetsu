    ...
    methods: {
        ...
        getBannerStyle(friend) {
            if (friend.bannerColors?.colour1 && friend.bannerColors?.colour2) {
                const colour1RGBA = friend.bannerColors.colour1.replace('rgb', 'rgba').replace(')', ', 0.25)');
                const colour2RGBA = friend.bannerColors.colour2.replace('rgb', 'rgba').replace(')', ', 0.25)');
                return {
