const rankRequestApp = Soumetsu.createApp({
	...
	methods: {
		...
		loadMoreRequests() {
			if (this.requestsLoading || !this.hasMoreRequests) {return;}
			this.requestsPage++;
		...
		getDifficultyColor(sr) {
			if (sr < 2) {return '136, 204, 51';}
			if (sr < 2.7) {return '102, 204, 255';}
			if (sr < 4) {return '255, 204, 51';}
			if (sr < 5.3) {return '255, 102, 153';}
			if (sr < 6.5) {return '153, 51, 255';}
			if (sr < 8) {return '51, 51, 51';}
			return '0, 0, 0';
		},
