const beatmapApp = Soumetsu.createApp({
    ...
    computed: {
        ...
        rankedStatusDisplay() {
            ...
            const statusMap = {
                '-2': { text: 'Graveyard', icon: 'fa-skull', class: 'bg-gray-500/20 text-gray-400 border-gray-500/30' },
                '-1': { text: 'WIP', icon: 'fa-hammer', class: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30' },
                '0': { text: 'Pending', icon: 'fa-clock', class: 'bg-blue-500/20 text-blue-400 border-blue-500/30' },
                '1': { text: 'Needs Update', icon: 'fa-sync', class: 'bg-orange-500/20 text-orange-400 border-orange-500/30' },
                '2': { text: 'Ranked', icon: 'fa-angle-double-up', class: 'bg-green-500/20 text-green-400 border-green-500/30' },
                '3': { text: 'Approved', icon: 'fa-check', class: 'bg-green-500/20 text-green-400 border-green-500/30' },
                '4': { text: 'Qualified', icon: 'fa-certificate', class: 'bg-cyan-500/20 text-cyan-400 border-cyan-500/30' },
                '5': { text: 'Loved', icon: 'fa-heart', class: 'bg-pink-500/20 text-pink-400 border-pink-500/30' },
            };
            return statusMap[String(status)] || { text: 'Unknown', icon: 'fa-question', class: 'bg-gray-500/20 text-gray-400 border-gray-500/30' };
        },
        canRequestRanking() {
