...
const SoumetsuHelpers = {
  ...
  humanizeLabel(number) {
    ...
    if (absNum >= 1.0e12) {
      return (absNum / 1.0e12).toFixed(2) + ' trillion';
    }
    if (absNum >= 1.0e9) {
      return (absNum / 1.0e9).toFixed(2) + ' billion';
    }
    if (absNum >= 1.0e6) {
      return (absNum / 1.0e6).toFixed(2) + ' million';
    }
    if (absNum >= 1.0e3) {
      return (absNum / 1.0e3).toFixed(2) + ' thousand';
    }
    return absNum;
  },
