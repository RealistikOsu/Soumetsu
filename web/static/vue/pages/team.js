    ...
    methods: {
        ...
        getBannerStyle(member) {
            if (member.bannerColors?.colour1 && member.bannerColors?.colour2) {
                const colour1RGBA = member.bannerColors.colour1.replace('rgb', 'rgba').replace(')', ', 0.25)');
                const colour2RGBA = member.bannerColors.colour2.replace('rgb', 'rgba').replace(')', ', 0.25)');
                return {
        ...
        getGroupColor(badgeId) {
            const colors = {
                2: { bg: 'bg-primary/20', text: 'text-primary', gradient: 'from-primary/10 via-transparent to-blue-500/10' },
                1018: { bg: 'bg-red-500/20', text: 'text-red-400', gradient: 'from-red-500/10 via-transparent to-pink-500/10' },
                1020: { bg: 'bg-purple-500/20', text: 'text-purple-400', gradient: 'from-purple-500/10 via-transparent to-indigo-500/10' },
                30: { bg: 'bg-green-500/20', text: 'text-green-400', gradient: 'from-green-500/10 via-transparent to-emerald-500/10' },
                5: { bg: 'bg-pink-500/20', text: 'text-pink-400', gradient: 'from-pink-500/10 via-transparent to-rose-500/10' },
                1017: { bg: 'bg-cyan-500/20', text: 'text-cyan-400', gradient: 'from-cyan-500/10 via-transparent to-blue-500/10' },
            };
            return colors[badgeId] || { bg: 'bg-gray-500/20', text: 'text-gray-400', gradient: 'from-gray-500/10 via-transparent to-gray-500/10' };
        },
