...
function _api(e, t, n, i, o, r, a) {
    ...
    var s = "An error occurred while contacting the RealistikOsu API. Please report this to RealistikOsu developer.";
    $.ajax({
        method: r ? "POST" : "GET",
        dataType: "json",
        url: e + t,
        ...
        success: function(e) {
            if (200 != e.code && !t.startsWith("profile-history")) {
...
function api(e, t, n, i, o, r) {
    return _api(soumetsuConf.baseAPI + "/api/v1/", e, t, n, i, o, r)
}

function banchoAPI(e, t, n, i, o, r) {
    return void 0 === i && (r = !0, i = function(e) {
        //console.warn("Silently failing."), console.warn(e)
    }), _api(soumetsuConf.banchoAPI + "/api/v2/", e, t, n, i, o, r)
}

function regularAPI(e, t, n, i, o, r) {
    return void 0 === i && (r = !0, i = function(e) {
        //console.warn("Silently failing."), console.warn(e)
    }), _api(soumetsuConf.banchoAPI + "/api/", e, t, n, i, o, r)
}
...
function convertIntToLabel(number) {
...
function getScoreMods(e, t) {
    ...
    return 512 == (512 & e) && (e &= -65), 16384 == (16384 & e) && (e &= -33), modsString.forEach(function(t, i) {
        (e & 1 << i) > 0 && n.push(t)
    }), n.length > 0 ? (t ? "" : "+ ") + n.join("") : t ? T("No Mod") : ""
}
...
function T(e, t) {
    return void 0 !== t && void 0 !== t.count && -1 === $.inArray(soumetsuConf.language, langWhitelist) && 1 !== t.count && (e = keyPlurals[e]), i18next.t(e, t)
}
...
var keyPlurals = {
    ...
    singlePageSnippets = {
        ...
        //         window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + "&rx=" + rx + "&sort=" + sort + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash),
        //         api("leaderboard", {
        //             mode: favouriteMode,
        //             p: page,
        //             l: 50,
        ...
        //                 if (rx == 1) {
        //                     n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/rx/u/" + e.id + "' title='View profile'><img class='new-flag' src='https://ussr.pl/static/flags/" + e.country + ".png'></img>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp, sort === "score")), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
        //                 }
        //                 if (rx == 2) {
        //                     n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/ap/u/" + e.id + "' title='View profile'><img class='new-flag' src='https://ussr.pl/static/flags/" + e.country + ".png'></img>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp, sort === "score")), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
        //                 }
        //                 if (rx == 0) {
        //                     n.append($("<tr />").append($("<td />").text("#" + (50 * (page - 1) + ++i)), $("<td />").html("<a href='/u/" + e.id +"' title='View profile'><img class='new-flag' src='https://ussr.pl/static/flags/" + e.country + ".png'></img>" + escapeHTML(e.username) + "</a>"), $("<td />").html(t(e.chosen_mode.ranked_score, e.chosen_mode.pp, sort === "score")), $("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), $("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>")))
        //                 }
        ...
        //     function t(e, t, s) {
        //         if (MobileCheck())
        //             return 0 === t ? `<b>${convertIntToLabel(e)}</b>` : (s ? `<b>${convertIntToLabel(e)}</b>` : `<b>${addCommas(t)}pp</b>`)
        //         // in other case return span label.
        //         return 0 === t ? `<span class data-tooltip=${addCommas(e)}><b>${convertIntToLabel(e)}</b></span>` : (s ? `<span class data-tooltip=${addCommas(e)}><b>${convertIntToLabel(e)}</b></span>` : `<b>${addCommas(t)}pp</b>`)
        //     }
        ...
        //     }), $("#sort-menu .item").click(function(t) {
        //         t.preventDefault(), $("#sort-menu .active.item").removeClass("active"), $(this).addClass("active"), sort = $(this).data("sort"), country = "", page = 1, e()
        //     })
        // },
        "/friends": function() {
            $("[id=friend-button]").click(function() {
                var e = $(this),
                    t = "1" === e.data("deleted") ? "add" : "del";
                console.log(t), e.addClass("disabled"), api("friends/" + t, {
                    user: +e.data("userid")
                }, function(t) {
                    e.removeClass("disabled"), e.data("deleted", t.friend ? "0" : "1"), e.find(".icon").removeClass("minus plus heart").removeClass("green red blue").addClass(t.friend ? t.mutual ? "red heart" : "green minus" : "blue plus"), e.find("span").text(t.friend ? T(t.mutual ? "Unmutual" : "Remove") : T("Add"))
                }, !0)
            })
        },
        "/team": function() {
        ...
        "/register/verify": function() {
            ...
            setInterval(function() {
                $.getJSON(soumetsuConf.banchoAPI + "/api/v1/verifiedStatus?u=" + e, function(t) {
        ...
        "/rank-request" : function() {
            ...
            var bmapIDRegex = /https:\/\/(ppy|ussr)\.(sh|pl)\/(b|beatmaps)\/(\d+)/gi;
            var bmapSetIDRegex = /https:\/\/(ppy|ussr)\.(sh|pl)\/(s|beatmapsets)\/(\d+)(#(.+)\/(.+))?/gi;
            $("#b-form")
              .submit(function(e) {
                e.preventDefault(); // Fuck osu subdomain
                var value = $("#beatmap").val().trim().replace("osu.", "");
                var bmapIDMatch = bmapIDRegex.exec(value);
                var bmapSetIDMatch = bmapSetIDRegex.exec(value);
                console.log(bmapIDMatch)
                console.log(bmapSetIDMatch)
                if (bmapIDMatch === null && bmapSetIDMatch === null) {
                  showMessage(
                    "error",
                    "Please provide a valid link, in the form " +
                            "of either https://ussr.pl/beatmaps/&lt;ID&gt; or any newer bancho link!");
                ...
                var postData = {};
                if (bmapIDMatch != null) {
                    postData.id = parseInt(bmapIDMatch[4])
                } else if (bmapSetIDMatch != null) {
                    postData.set_id = parseInt(bmapSetIDMatch[4])
                }
...
$(document).ready(function() {
    ...
    "function" == typeof e && e(), "function" == typeof deferredToPageLoad && deferredToPageLoad(), $("[id=user-search]").search({
        onSelect: function(e) {
            ...
            onResponse: function(e) {
                ...
                return $.each(e.users, function(e, n) {
                    t.results.push({
                        title: n.username,
                        url: "/u/" + n.id,
                        image: soumetsuConf.avatars + "/" + n.id
                    })
                }), t
            }
        }
    }), $("[id=user-search-input]").keypress(function(e) {
        13 == e.which && (window.location.pathname = "/users/" + $(this).val())
    }), $(document).keydown(function(e) {
        var t = $(document.activeElement),
            n = t.is(":input,[contenteditable]");
        83 !== e.which && 115 !== e.which || n || ($("[id=user-search-input]").focus(), e.preventDefault()), 27 === e.which && n && t.blur()
...
i18next.use(i18nextXHRBackend).init({
    ...
    load: "currentOnly",
    backend: {
        loadPath: "/static/locale/en.json"
    }
});
var i18nLoaded = -1 === $.inArray(soumetsuConf.language, langWhitelist);
